This Project is designed for the detection of the emotions or sentiments out of a song using its mp3 format. This projects is build from scratch using Python Open API like Librosa,
