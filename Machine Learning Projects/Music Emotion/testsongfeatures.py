...
x = joblib.load('energy.pkl')
energy = x.predict(f[enrg_feat])

print(energy)

valence_feat = ['contrast_mean',
 'cent_mean',
 'mfcc_delta_var',
 'mfcc_delta_std',
 'spec_bw_mean',
...
y = joblib.load('valance.pkl')
valance = y.predict(f[valence_feat])
